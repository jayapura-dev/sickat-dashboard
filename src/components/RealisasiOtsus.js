...
import { fetchRealisasiOtsus } from '../actions';
import NumberFormat from 'react-number-format';
import ReactToPdf from 'react-to-pdf';

class RealisasiOtsus extends React.Component {
    componentDidMount() {
        this.props.fetchRealisasiOtsus();
    }
            ...
            <div>
              <div className="ui segment">
                <div className="ui header">
                  <h4>REALISASI OTSUS (PERANGAKAT DAERAH)</h4>
                </div>
...
const mapStateToProps = (state) => {
    return { otsus:  Object.values(state.otsus) };
}

export default connect(mapStateToProps, { fetchRealisasiOtsus })(RealisasiOtsus);