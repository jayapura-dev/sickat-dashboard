...
import { fetchRealisasiDbh } from '../actions';
import NumberFormat from 'react-number-format';
import ReactToPdf from 'react-to-pdf';

class RealisasiDbh extends React.Component {
    componentDidMount() {
        this.props.fetchRealisasiDbh();
    }
            ...
            <div>
              <div className="ui segment">
                <div className="ui header">
                  <h4>REALISASI DBH (PERANGAKAT DAERAH)</h4>
                </div>
...
const mapStateToProps = (state) => {
    return { dbh:  Object.values(state.dbh) };
}

export default connect(mapStateToProps, { fetchRealisasiDbh })(RealisasiDbh);